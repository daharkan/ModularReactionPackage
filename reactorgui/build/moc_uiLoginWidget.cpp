/****************************************************************************
** Meta object code from reading C++ file 'uiLoginWidget.h'
**
...
#error "The header file 'uiLoginWidget.h' doesn't include <QObject>."
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSLoginWidgetENDCLASS_t qt_meta_stringdata_CLASSLoginWidgetENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 16),  // "sgn_loginSucceed"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 15),  // "sgn_loginFailed"
        QT_MOC_LITERAL(46, 12)   // "loginPressed"
    },
    "LoginWidget",
    "sgn_loginSucceed",
    "",
...
Q_CONSTINIT const QMetaObject LoginWidget::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoginWidgetENDCLASS_t,
        ...
        // method 'sgn_loginSucceed'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'sgn_loginFailed'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'loginPressed'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sgn_loginSucceed(); break;
        case 1: _t->sgn_loginFailed(); break;
        case 2: _t->loginPressed(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoginWidget::sgn_loginSucceed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LoginWidget::*)();
            if (_t _q_method = &LoginWidget::sgn_loginFailed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LoginWidget::sgn_loginSucceed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void LoginWidget::sgn_loginFailed()
{
