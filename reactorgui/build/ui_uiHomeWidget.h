...
public:
    ...
    void setupUi(QWidget *HomeWidget)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/resources/icons/grid.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/resources/icons/bar chart.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/resources/icons/settings.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/resources/icons/users.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/resources/icons/power on.svg"), QSize(), QIcon::Normal, QIcon::Off);
