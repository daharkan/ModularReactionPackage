...
namespace {
struct qt_meta_tag_ZN10CellWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto CellWidget::qt_create_metaobjectdata<qt_meta_tag_ZN10CellWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<CellWidget, qt_meta_tag_ZN10CellWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject CellWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10CellWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10CellWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10CellWidgetE_t>.metaTypes,
    nullptr
} };
...
void *CellWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10CellWidgetE_t>.strings))
