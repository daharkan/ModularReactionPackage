...
public:
    ...
    void setupUi(QMainWindow *TSMainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/resources/icons/undo.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/resources/icons/home.svg"), QSize(), QIcon::Normal, QIcon::Off);
